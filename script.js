...
if (isSubmitted) disableForm();
updateShareText();

shareBtn.onclick = () => {
  if (shareCount < 5) {
    const message = encodeURIComponent("Hey Buddy, Join Tech For Girls Community at https://your-username.github.io/tech-for-girls-registration/"
    );
